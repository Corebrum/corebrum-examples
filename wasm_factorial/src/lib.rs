// WASM Factorial Implementation
// This will be compiled to WebAssembly and executed by the Corebrum system
...
pub fn compute_factorial_with_metadata(n: u32, worker_id: &str) -> String {
    ...
    let result = format!(
        r#"{{"factorial":{},"input_number":{},"computation_time_ms":{},"worker_id":"{}","method":"wasm","timestamp":"{}"}}"#,
        factorial_result,
        n,
        computation_time_ms,
        worker_id,
    ...
    console_log!("WASM Factorial computed: {}", result);
    result
}
...
pub fn get_module_info() -> String {
    r#"{"name":"factorial_wasm","version":"1.0","description":"WebAssembly factorial computation","language":"rust","target":"wasm32"}"#.to_string()
}

// This function is called when the WASM module is instantiated
#[wasm_bindgen(start)]
pub fn main() {
    console_log!("WASM Factorial module loaded successfully!");
}
